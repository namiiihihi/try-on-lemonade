...
const FALLBACK_SHADES: Product[] = [
  ...
  { id: 'v2-01', name: '01. Your Crush',           hex: '#CC2850', opacity: 0.80, finish: 'glossy', collection: 'Mirror Mirror Water Tint', price: 169000, image_url: `${IMG}/6_bb24a3fe52c642ee8fda6a46c5661642.jpg`,  store_url: url(1119301610) },
  { id: 'v2-02', name: '02. Iconic Coral',         hex: '#C85035', opacity: 0.72, finish: 'glossy', collection: 'Mirror Mirror Water Tint', price: 169000, image_url: `${IMG}/7_77ff31fbe7554cff8b7aef97051f3543.jpg`,  store_url: url(1119301614) },
  { id: 'v2-03', name: '03. My Own Nude',          hex: '#C07858', opacity: 0.65, finish: 'glossy', collection: 'Mirror Mirror Water Tint', price: 169000, image_url: `${IMG}/8_2cc02d985b4448f3b5aa50eb64a9e7ed.jpg`,  store_url: url(1119301621) },
  { id: 'v2-04', name: '04. Baby Rosy',            hex: '#E88A78', opacity: 0.62, finish: 'glossy', collection: 'Mirror Mirror Water Tint', price: 169000, image_url: `${IMG}/9_bac2f94e16e14912a90f130c2472725f.jpg`,  store_url: url(1119301644) },
  { id: 'v2-05', name: '05. No Cap',               hex: '#CC6078', opacity: 0.70, finish: 'glossy', collection: 'Mirror Mirror Water Tint', price: 169000, image_url: `${IMG}/10_435f73e83f3546cfb1290fb4ecd1bb4f.jpg`, store_url: url(1119301653) },
